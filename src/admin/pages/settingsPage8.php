...
-->
    ...
    <script src="https://cdn.jsdelivr.net/npm/locutus@2.0.14/index.js"></script>
...
<div class="vue-div container-fluid" id="vue-div">
    ...
    <div class="row mt-5">        
        ...
        <div class="card col-3 rounded border border-primary text-center mx-auto">
            <a href="#page-search">Go to Search</a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="card col rounded border border-primary">
            <div class="card-body">
                ...
                <div class="card-text">
                    <ul class="list-group-sm">
                        <li class="list-group-item active">All Local DB Manufacturers ({{buildersInfoList1.length}})</li>
        ...
        <div class="card col rounded border border-primary">
            <div class="card-body">
                ...
                <div class="card-text">
                    <ul class="list-group-sm mb-0">
                        <li class="list-group-item active mb-0">All Local DB Categories ({{categoriesMasterList1.length}})</li>
                    ...
                    <div class="row p-0 m-0">
                        <!-- <div v-for="(cat, index) in categoriesMasterList1" v-if="cat.length > 0" class='col-6'> -->
                        <div v-for="(cat, index) in categoriesMasterList1"  class='col-4 rounded border border-secondary p-2 text-center'>
                            <!-- {{index}}: {{cat}}                         -->
                            {{cat}}                        
                        </div>
                    </div>
    ...
    <form v-on:submit.prevent="function(){ ; }" class="bg-transparent">
        ...
        <div class="row border border-info rounded p-3 pt-0 mt-2 ">
            ...
            <div class="scec_categories row col-12 m-0 p-0">
                <a name="page-search" href="#page-top">Go to top of page</a>                                    
            </div>
            ...
            <div class="row col-12 m-0 p-0">
                ...
                <div class="card col-6 px-3">
                    <div class="row pl-0">
                        ...
                        <div class="col-auto ms-auto border mr-3">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" name="searchTerm" id="name_term" value="name" type="radio">
                                <label class="form-check-label" for="name_term">Name:</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input class="form-check-input" name="searchTerm" id="part_num_term" value="part_num" type="radio">
                                <label class="form-check-label" for="part_num_term">Part Number</label>
                            </div>
                        </div>
                    </div>

                    <div class="row px-3  pt-2">
                        <input class="col-12" v-model="searchTerm" name="searchTxt" id="seatchTxt" type="text" value="Search for ..." placeholder="Search for ...">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div>
                            <label for=""></label>
                            <input name="searchTerm" id="" value="" type="radio">                    
                        </div>
                        -->
                    </div>
            ...
            methods: {
                onClickDisplayPartsNumbers: function(event){
                    jQuery.ajax({
                        ...
                        data:{
                            action: 'scadmin_local_ajax_settings',
                ...
                onCategoryChange1: function(event) {
                    ...
                    jQuery.ajax({
                        ...
                        data: {
                            action: 'scadmin_local_getMultitudes',
                            nonce: '<?php echo $scec_nonce ?>',
                            todo: 'getsome',
                            what: 'builders',
                            subWhat: "",
